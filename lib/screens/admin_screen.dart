        ...
        children: [
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.security, color: Color(0xFFE65100), size: 24),
                ),
          ...
          GridView.count(
            ...
            children: [
              ...
              _buildKpiCard('In Progress', '$inProgCount', const Color(0xFFE65100)),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Text('#${c.id}', style: GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.bold, color: const Color(0xFFE65100))),
